...
<template>
  <div class="pl-64 h-screen">
    <div class="sticky top-[100vh] h-24 border-t-2 border-gray-200">
      <form class="flex space-x-4 m-5 align-middle items-center" @submit.prevent="sendMessage">
        <div class="mt-1 w-full">
          <input type="text" name="name" id="name" v-model="newMessage"
            class="w-full block rounded-full border-gray-300 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
            placeholder="Hi2u" />
        </div>
        <div>
          <button type="submit"
